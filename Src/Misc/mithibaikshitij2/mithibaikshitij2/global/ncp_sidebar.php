...
<div class="main" id="sidebar">
    <div class=" d-flex flex-column flex-shrink-0 p-3 text-white bg-dark kunal " >
      <a href="" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none ">
       <div class="cont">
         <img class="logo" src="../assets/logo.png" />
         <h1 class="fs-4">NCP Dashboard</h1>
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item hoverr">
          <a href="../dashboard/NCP_dashboard.php" class="nav-link text-white"  aria-current="page">
            
            Dashboard
          </a>
        </li>
        <li  class=" hoverr">
          <a href="../events/ncpeventregistration.php"  class="nav-link text-white">
        ...
        <li class="nav-item hoverr">
          <a href="../dashboard/NCP_departments.php" class="nav-link text-white">
