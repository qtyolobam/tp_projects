...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $event=$_POST['events'];
        ...
        //function
        // function updateLeaderboard($zzz,$event,$pt,$cc){
          ...
          $pt = $data['bet_point'];
            ...
            if ($status_result_row['result'] == "Result Awaited"){
              ...
              if($zzz == "NPR"){
                ...
                if($conn->query($sql) == true){                
                  // echo "<script></script>";
                  echo "<script>alert('NPR to this $cc for $event')</script>"; 
                ...
                elseif($zzz=="Qualification"){
                  ...
                  if($conn->query($sql) == true){                
                    // echo "Hogya";
                    echo "<script>alert('$zzz to this $cc for $event')</script>"; 
                    echo '<script>window.location.href = "result.php";</script>';
                ...
                elseif ($status_result_row['result'] == "Qualification"){
                  if($zzz == "NPQ"){
                    ...
                    //elseif podium 1,2,3
                    elseif ($zzz == "podium_1" || $zzz == "podium_2" || $zzz == "podium_3"){
                      ...
                      $sql3 = "update cc_regi_point SET result = '$zzz' WHERE ccid = '$cc' and event_name = '$event' ;";  // Use select query here          
                ...
                elseif ($status_result_row['result'] == "podium_1" || $status_result_row['result'] == "podium_2" || $status_result_row['result'] == "podium_3" || $status_result_row['result'] == "loss" || $status_result_row['result'] == "NPR" || $status_result_row['result'] == "NPQ"){
                  if($zzz){
                    $previous = $status_result_row['result'];
                    echo "<script>alert('You Have already given $previous to this $cc')</script>"; 
                    echo '<script>window.location.href = "result.php";</script>';
...
            </div>
            ...
            <div >
              ...
              <label for="NPR">1<sup>st</sup> Podium</label>
            </div>
            <div >
              <input type="radio" id="podium_2" name="result" value="podium_2">
              <label for="NPQ">2<sup>nd</sup> Podium</label>
            </div>
            <div>            
              <input type="radio" id="podium_3" name="result" value="podium_3">
              <label for="podium_3">3<sup>st</sup> Podium</label>
            </div>
            <div >
