...
$sqll = "SELECT event_name FROM ncpeventregi WHERE event_name = '$event' and ncpid='$loginuser' ";
            ...
            $stmt = mysqli_prepare($conn, $sqll);
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    {
                        $everything=false;
                        echo '<script>confirm("You have already registered for this event!")</script>';
                        echo '<script>window.location.href = "ncpeventregistration.php";</script>';
...
?>
    ...
    <title>NCP Event Registration</title>
...
<header class="dashboard">
    ...
    <div class="container-manual">
        <h1>NCP Event Registration Form</h1>
        ...
        <form action="ncpeventregistration.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3" id="events">
                <label class="form-label">Event Name *</label>
                 <select name="event" id="event-list" required>
            ...
            <div class="mb-3" id="dimg2" name="dimg2" style=display:none>
                <label for="img2" class="form-label" >College ID proof / Fee Receipt *</label>
            ...
            <div class="mb-3" id="dimg3" name="dimg3" style=display:none>
                <label for="img3" class="form-label">College ID proof / Fee Receipt * </label>
            ...
            <div class="mb-3" id="dimg4" name="dimg4" style=display:none>
                <label for="img4" class="form-label">College ID proof / Fee Receipt *</label>
            ...
            <div class="mb-3" id="dimg5" name="dimg5" style=display:none>
                <label for="img5" class="form-label">College ID proof / Fee Receipt *</label>
            ...
            <div class="mb-3" id="dimg6" name="dimg6" style=display:none>
                <label for="img6" class="form-label">College ID proof / Fee Receipt *</label>
            ...
            <div class="mb-3" id="dimg7" name="dimg7" style=display:none>
                <label for="img7" class="form-label">College ID proof / Fee Receipt *</label>
            ...
            <div class="mb-3" id="dimg8" name="dimg8" style=display:none>
                <label for="img8" class="form-label">College ID proof / Fee Receipt * </label>
