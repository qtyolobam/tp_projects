...
elseif(empty($npa2) && empty($npa1)){
    ...
    if($everything){
        ...
        $update_count_sql = "select update_count from cceventregi where event_name = '$event' and ccid = '$loginuser'";
...
if ($update_count==0){
        if (mysqli_num_rows($event_date_result) > 0) {
            ...
            if ($gap>='1' && $gap<='3'){
                ...
                $sql = "update cceventregi set email_id = '$email,$p1email', participant_name = '$fullname', phone_number = '$mob', idproof='$images', govt_id='$govt_images',attachment='$attachment', update_count=1 where ccid='$loginuser' and event_name='$event';";
                // Execute the query
    ...
    elseif($update_count==1){
        echo "Hey You have already updated once !";
    }                     
...
<body>
  ...
  <header class="dashboard">
    ...
    <div class="container-manual">
        ...
        <form action="ccsubstitute.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
