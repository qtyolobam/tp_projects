...
<?php
  ...
  require_once "../includes/config.php";
    ...
    //Get ID, Name, Mob
    $sql = "SELECT fname,lname,collegename,email,phone,dob from pi_regi where NCPID='$loginuser'";//idr login krne ke baad session id se compare karna hoga
...
//for collegeid / fee
        ...
        elseif(!empty($file11) && !empty($file22) && !empty($file33) && !empty($file44) && !empty($file55) && !empty($file66) && !empty($file77)){
            $data=[$file1,$file2,$file3,$file4,$file5,$file6,$file7];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11) && !empty($file22) && !empty($file33) && !empty($file44) && !empty($file55) && !empty($file66)){
            $data=[$file1,$file2,$file3,$file4,$file5,$file6];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11) && !empty($file22) && !empty($file33) && !empty($file44) && !empty($file55)){
            $data=[$file1,$file2,$file3,$file4,$file5];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11) && !empty($file22) && !empty($file33) && !empty($file44)){
            $data=[$file1,$file2,$file3,$file4];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11) && !empty($file22) && !empty($file33)){
            $data=[$file1,$file2,$file3];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11) && !empty($file22)){
            $data=[$file1,$file2];
            $images=implode(' ',$data); 
        }
        elseif(!empty($file11)){
        ...
        // if(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33) && !empty($govt_file44) && !empty($govt_file55) && !empty($govt_file66) && !empty($govt_file77) && !empty($govt_file88)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3,$govt_file4,$govt_file5,$govt_file6,$govt_file7,$govt_file8];
        //     $govt_images=implode(' ',$govt_data);
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33) && !empty($govt_file44) && !empty($govt_file55) && !empty($govt_file66) && !empty($govt_file77)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3,$govt_file4,$govt_file5,$govt_file6,$govt_file7];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33) && !empty($govt_file44) && !empty($govt_file55) && !empty($govt_file66)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3,$govt_file4,$govt_file5,$govt_file6];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33) && !empty($govt_file44) && !empty($govt_file55)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3,$govt_file4,$govt_file5];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33) && !empty($govt_file44)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3,$govt_file4];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22) && !empty($govt_file33)){
        //     $govt_data=[$govt_file1,$govt_file2,$govt_file3];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11) && !empty($govt_file22)){
        //     $govt_data=[$govt_file1,$govt_file2];
        //     $govt_images=implode(' ',$govt_data); 
        // }
        // elseif(!empty($govt_file11)){
        //     $govt_data=[$govt_file1];
        //     $govt_images=implode(' ',$govt_data); 
        // }
...
// $sqll = "SELECT event_name FROM ncpeventregi WHERE event_name = '$event' and ncpid='$loginuser' ";
...
$headers = "From: testmailkshitij@gmail.com";
    ...
    elseif(empty($p3) && empty($p4) && empty($p5) && empty($p6) && empty($p7) && empty($p8) ){
        $fullname= $fname." ".$lname." \nP2 : ".$p2;
        if(isDigits($phone) && isDigits($p2num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num;
        }else{
            echo "number wrong";
    ...
    elseif(empty($p4) && empty($p5) && empty($p6) && empty($p7) && empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num." ".$p3num;
        }else{
            echo "number wrong";
    ...
    elseif(empty($p5) && empty($p6) && empty($p7) && empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3." \nP4 : ".$p4;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num) && isDigits($p4num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num." \nP3 ".$p3num." \nP4 ".$p4num;
        }else{
            echo "number wrong";
    ...
    elseif(empty($p6) && empty($p7) && empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3." \nP4 : ".$p4." \nP5 : ".$p5;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num) && isDigits($p4num) && isDigits($p5num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num." \nP3 ".$p3num." \nP4 ".$p4num." \nP5 ".$p5num;
        }else{
            echo "number wrong";
    ...
    elseif(empty($p7) && empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3." \nP4 : ".$p4." \nP5 : ".$p5." \nP6 : ".$p6;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num) && isDigits($p4num) && isDigits($p5num) && isDigits($p6num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num." \nP3 ".$p3num." \nP4 ".$p4num." \nP5 ".$p5num." \nP6 ".$p6num;
        }else{
            echo "number wrong";
    ...
    elseif(empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3." \nP4 : ".$p4." \nP5 : ".$p5." \nP6 : ".$p6." \nP7 : ".$p7;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num) && isDigits($p4num) && isDigits($p5num) && isDigits($p6num) && isDigits($p7num)){
            // $phonevalidate=true;
            $mob = $phone." \nP2 ".$p2num." \nP3 ".$p3num." \nP4 ".$p4num." \nP5 ".$p5num." \nP6 ".$p6num." \nP7 ".$p7num;
        }else{
            echo "number wrong";
    ...
    elseif(!empty($p2) && !empty($p3) && !empty($p4) && !empty($p5) && !empty($p6) && !empty($p7) && !empty($p8)){
        $fullname= $fname." ".$lname." \nP2 : ".$p2." \nP3 : ".$p3." \nP4 : ".$p4." \nP5 : ".$p5." \nP6 : ".$p6." \nP7 : ".$p7." \nP8 : ".$p8;
        if(isDigits($phone) && isDigits($p2num) && isDigits($p3num) && isDigits($p4num) && isDigits($p5num) && isDigits($p6num) && isDigits($p7num) && isDigits($p8num)){
            $mob = $phone." \nP2 ".$p2num." \nP3 ".$p3num." \nP4 ".$p4num." \nP5 ".$p5num." \nP6 ".$p6num." \nP7 ".$p7num." \nP8 ".$p8num;
        }else{
            echo "number wrong";
           $everything=false;
    ...
    if($everything){
        ...
        $update_count_sql = "select update_count from ncpeventregi where event_name = '$event' and ncpid = '$loginuser'";
        $update_count_result = mysqli_query($conn,$update_count_sql);
        while($update_count_row=mysqli_fetch_array($update_count_result)){
        ...
        if ($update_count==0){
            ...
            //   echo "<br>".$gap;
              if ($gap>='1' && $gap<='3'){
                ...
                // $sql = "INSERT INTO `ncpeventregi` (`ncpid`, `dept_name`,`event_name`,`participant_name`,`mobilenum`,`idproof`,`govt_id`,`attachment`,`timeofregistration`) VALUES ('$loginuser','$deptname','$event','$fullname','$mob','$images','$govt_images','$attachment',current_timestamp());";
                $sql = "update ncpeventregi set event_name = '$event', participant_name = '$fullname', mobilenum = '$mob', idproof = '$images', govt_id = '$govt_images', attachment = '$attachment', update_count = 1 where ncpid='$loginuser' and event_name='$event';";
                // Execute the query
                ...
                echo "<script>alert('Your Request for Substitute has been accepted for $event an Acknowledgement for the same has been sent to your Registered Email !')</script>";
                echo '<script>window.location.href = "ncpsubstitute.php";</script>';
        ...
        elseif($update_count==1){
            echo "<script>alert('Sorry Substitution Can be done only Once, You have already Substituted once for this $event !')</script>";
            echo '<script>window.location.href = "ncpsubstitute.php";</script>';
        }
...
<header class="dashboard">
    ...
    <div class="container-manual">
        <h1>NCP Substitution Form</h1>
        <p>Enter your details and submit this form to update substitute </p>
        <hr>
        <!-- display success message -->
        <?php
        if($insert == true){
        echo "<script>alert(Form Submitted Successfully and Acknowledgment Mail has been sent !)</script>";
        }
        ?>


        <form action="ncpsubstitute.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="fname" class="form-label">First Name *</label>
                <input type="text" name="fname" id="fname"  value = "<?php echo $first_name;?>" readonly required>
            </div>
            <div class="mb-3">
                <label for="lname" class="form-label">Last Name *</label>
                <input type="text" name="lname" id="lname" value = "<?php echo $last_name;?>" readonly  required>
            </div>
            <!-- <div class="mb-3">
                <label for="mob" class="form-label">Mobile Number</label>
                <input type="text" name="mob" id="mob" value = "<?php echo $mob;?>" readonly  required>
            </div> -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" id="email" value = "<?php echo $email_id;?>" readonly required>
            </div>
            <div class="mb-3">
                <label for="phone" class="form-label">Phone number *</label>
                <input type="phone" name="phone" id="phone" value = "<?php echo $phone_no;?>" readonly required >
            </div>
            <div class="mb-3">
                <label for="date" class="form-label">DOB *</label>
                <input type="date" name="dob" id="dob" value = "<?php echo $dobb;?>" readonly  required>
            </div>
            ...
            <div class="mb-3" id="events">
                ...
                <?php 
                     $sql = "select events.event_name from events where events.group_event = 1 INTERSECT select ncpeventregi.event_name from ncpeventregi where ncpeventregi.ncpid = '$loginuser';";
            ...
            <div class="mb-3">
                <label for="img1" class="form-label">College ID / Fee Receipt (Max:500 Kb)*</label>
                <input class="black" type="file" name="img1" id="img1" required accept="image/png, image/jpeg, image/jpg" >
            </div>
            <div class="mb-3">
                <label for="govt_img1" class="form-label">Government ID Proof (Max:500 Kb)</label>
            ...
            <div class="mb-3" id="dimg2" name="dimg2" style=display:none>
                <label for="img2" class="form-label" >College ID / Fee Receipt (Max:500 Kb)*</label>
            ...
            <div class="mb-3" id="govt_dimg2" name="govt_dimg2" style=display:none>
                <label for="govt_img2" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg3" name="dimg3" style=display:none>
                <label for="img3" class="form-label">College ID / Fee Receipt (Max:500 Kb)* </label>
            ...
            <div class="mb-3" id="govt_dimg3" name="govt_dimg3" style=display:none>
                <label for="govt_img3" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg4" name="dimg4" style=display:none>
                <label for="img4" class="form-label">College ID / Fee Receipt (Max:500 Kb)*</label>
            ...
            <div class="mb-3" id="govt_dimg4" name="govt_dimg4" style=display:none>
                <label for="govt_img4" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg5" name="dimg5" style=display:none>
                <label for="img5" class="form-label">College ID / Fee Receipt (Max:500 Kb)* </label>
            ...
            <div class="mb-3" id="govt_dimg5" name="govt_dimg5" style=display:none>
                <label for="govt_img5" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg6" name="dimg6" style=display:none>
                <label for="img6" class="form-label">College ID / Fee Receipt (Max:500 Kb)*</label>
            ...
            <div class="mb-3" id="govt_dimg6" name="govt_dimg6" style=display:none>
                <label for="govt_img6" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg7" name="dimg7" style=display:none>
                <label for="img7" class="form-label">College ID / Fee Receipt (Max:500 Kb)* </label>
            ...
            <div class="mb-3" id="govt_dimg7" name="govt_dimg7" style=display:none>
                <label for="govt_img7" class="form-label" >Government ID Proof (Max:500 Kb) </label>
            ...
            <div class="mb-3" id="dimg8" name="dimg8" style=display:none>
                <label for="img8" class="form-label">College ID / Fee Receipt (Max:500 Kb)*</label>
            ...
            <div class="mb-3" id="govt_dimg8" name="govt_dimg8" style=display:none>
                <label for="govt_img8" class="form-label" >Government ID Proof (Max:500 Kb) </label>
