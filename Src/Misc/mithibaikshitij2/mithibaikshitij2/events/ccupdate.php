...
if ($update_count==0){
        if (mysqli_num_rows($event_date_result) > 0) {
            ...
            if ($gap>='1' && $gap<='3'){
                ...
                $sql = "update cceventregi set email_id = '$email.$p1email', participant_name = '$fullname', phone_number = '$mob', idproof='$images', attachment='$attachment', update_count=1 where ccid='$loginuser' and event_name='$event';";
                // Execute the query
    ...
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <!-- <div class="mb-3">
                ...
                <input type="phone" name="phone" id="phone" value = "<?php echo $phone;?>" readonly required >
            </div> -->
            <!-- <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="black" type="file" name="img1" id="img1" accept="image/png, image/jpeg, image/jpg" required >
            </div>
     ...
     <script>
        //  $(document).ready(function(){  
            ...
            if ($("input#attachment").val().indexOf("drive.google.com") != -1){
                
            }  
            else{
                alert('Please Enter the Correct Drive Link');
                $("input:text").val("");
            }
